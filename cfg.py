...
def parse_args():    
    ...
    parser.add_argument('-mod', type=str, default='seg', help='mod type:seg,cls,val_ad')
    parser.add_argument('-exp_name', default='CAG_Samadapt1024_512_1e-2', type=str, help='net type')
    parser.add_argument('-type', type=str, default='map', help='condition type:ave,rand,rand_map')
    parser.add_argument('-vis', type=int, default=25, help='visualization')
    ...
    parser.add_argument('-weights', type=str, default = 0 , help='the weights file you want to test')  #'/home/s_04/Medical-SAM-Adapter/logs/CAG_Samadapt_V2_lr3e2_2024_04_02_09_17_21/Model/checkpoint_best.pth'
    ...
    parser.add_argument('-dataset', default='CAG' ,type=str,help='dataset name')
